...
f = figure('Position', [100, 100, 600, 400], 'Name', 'Neural Network Predictor', 'NumberTitle', 'off', 'MenuBar', 'none');

uicontrol('Style', 'text', 'Position', [50, 320, 150, 20], 'String', 'Roughness (hrms):', 'HorizontalAlignment', 'left');
hrms_input = uicontrol('Style', 'edit', 'Position', [200, 320, 350, 20]);

uicontrol('Style', 'text', 'Position', [50, 280, 150, 20], 'String', 'Young''s Modulus (E*):', 'HorizontalAlignment', 'left');
E_input = uicontrol('Style', 'edit', 'Position', [200, 280, 350, 20]);

uicontrol('Style', 'text', 'Position', [50, 240, 150, 20], 'String', 'Poisson''s Ratio:', 'HorizontalAlignment', 'left');
nu_input = uicontrol('Style', 'edit', 'Position', [200, 240, 350, 20]);

uicontrol('Style', 'pushbutton', 'Position', [250, 180, 100, 30], 'String', 'Predict', 'Callback', {@predict_callback, hrms_input, E_input, nu_input});

% Define a function to get W1 values
W1 = getW1();  % Function call to get W1 values

% Callback function for the 'Predict' button
function predict_callback(~, ~, hrms_input, E_input, nu_input)
...
function plot_predictions(net, input_value)
    % Assuming net and input_value are defined in the workspace
    predicted_output = net(input_value);
    
    % Create a new figure for the plot
    figure;
    plot(predicted_output, 'b-o');
